...
BEGIN_MESSAGE_MAP(CBmpShowView, CView)
	...
	ON_COMMAND(ID_FILE_PRINT_PREVIEW, &CBmpShowView::OnFilePrintPreview)
	ON_WM_CONTEXTMENU()
	ON_WM_RBUTTONUP()
END_MESSAGE_MAP()
...
void CBmpShowView::OnFilePrintPreview()
{
#ifndef SHARED_HANDLERS
...
void CBmpShowView::OnRButtonUp(UINT /* nFlags */, CPoint point)
{
	ClientToScreen(&point);
	OnContextMenu(this, point);
}

void CBmpShowView::OnContextMenu(CWnd* /* pWnd */, CPoint point)
{
#ifndef SHARED_HANDLERS
